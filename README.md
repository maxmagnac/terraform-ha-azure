...
Resource Group
Resource Group (screenshots/terraform_haweb_resource_group.png)

Virtual Network
Virtual Network (screenshots/terraform_haweb_vnet.png)
...
Terraform Apply (screenshots/terraform_haweb_terraform_apply.png)
